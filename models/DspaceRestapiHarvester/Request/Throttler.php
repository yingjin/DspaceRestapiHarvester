 ...
 * @package DspaceRestapiHarvester
 */
class DspaceRestapiHarvester_Request_Throttler
{
    /**
     * @var array
     */
    ...
    /**
     * @var DspaceRestapiHarvester_Request
     */
    private $_request;
     ...
     * Constructor
     *
     * @param DspaceRestapiHarvester_Request $request
    ...
    public function __construct($request, $options = array())
    {
        ...
        $this->_session = new Zend_Session_Namespace('DspaceRestapiHarvester_Request_Throttler');
     ...
     * thrown. 
     *
     * @throws DspaceRestapiHarvester_Request_ThrottlerException
     * @param string $m
     * @param array $a
     */
    public function __call($m, $a)
    {
        ...
        if ($this->_requestExceedsThreshold($m, $waitSecs)) {
            throw new DspaceRestapiHarvester_Request_ThrottlerException(
